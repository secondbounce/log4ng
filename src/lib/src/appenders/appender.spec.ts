...
// tslint:disable-next-line no-magic-numbers
    ...
    it('should render date/times in correct format',
      ...
      */
      ...
      let localeString: string = date.toLocaleString();           // 07/08/2017, 15:53:34
      localeString = localeString.slice(0, localeString.length - 1) + '\\d';
      let localeTimeString: string = date.toLocaleTimeString();   // 15:53:34
      localeTimeString = localeTimeString.slice(0, localeTimeString.length - 1) + '\\d';
