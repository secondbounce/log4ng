...
[travis-badge]: https://travis-ci.org/filipesilva/angular-log4ng.svg?branch=master
[travis-badge-url]: https://travis-ci.org/filipesilva/angular-log4ng
...
1. Create a project folder (you can call it `log4ng` and rename it later).
...
```
git clone https://github.com/filipesilva/angular-log4ng.git
cd angular-log4ng
npm install
npm start
```
...
### Download
[Download the QuickStart Library seed](https://github.com/filipesilva/angular-log4ng/archive/master.zip)
...
Use your editor to search the project for all instances of `log4ng` and change it
